    ...
    <div className="m-0 p-0 text-white">
      ...
      <div className="w-full h-[32vh] bg-catalogue-background-1 bg-cover flex justify-center items-end">
        <div className="w-full max-w-md flex flex-col items-center p-4">
          <h1 className="text-2xl my-1 arcade-font">Vyapaar Saarthi</h1>
          <h1 className="mt-2 text-center font-manrope text-xl text-gray-300">
          Accelerate your MSME's growth with our lightning-fast loan application process 
          </h1>
        </div>
      </div>
      <div className="max-w-screen w-full h-fit m-0 px-8 md:px-12 lg:px-16 xl:px-32 mx-auto text-white">
