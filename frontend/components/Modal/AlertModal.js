...
export default function AlertModal({ showModal, setShowModal, text, type, confirmButtonText, onConfirm, twitterNFTId, }) {
    if (showModal)
        return (
            <>
                  ...
                  ${type == 'error' ? 'bg-red-400 hover:bg-red-300' : 'bg-gray-500 hover:shadow-lg hover:bg-gray-600'}  
                   px-5 py-2 text-center mr-5`}>
                                    ...
                                    {twitterNFTId && (
                                        <a
                                            target={'_blank'}
                                            href={getIntentByNFTId(twitterNFTId)}
                                            className={
                                                'rounded-md px-4 py-2 text-center text-white text-lg bg-sky-600'
                                            }>
