...
import { loginWithEmail, signupWithEmail, connectToMetamask } from '../utils/user'
  ...
  return (
    <AuthLayout signIn={true}>
      <div className='flex flex-col w-full'>
        <div className={'text-2xl h-fit mt-8 ' + styles.arcadeFont}>LOG IN AS BANK</div>
        ...
        <div className='mt-4'>
          <h1>Register as a new bank? <a className='text-custom-blue' href='/banksignup'>Register</a></h1>
        </div>
      </div>
    </AuthLayout>
  );
